...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulate registration check (in a real app, this would be server-side)
      // For demo purposes, accept any valid form data
      
      // Check if user already exists in localStorage (simple demo logic)
      const existingUser = localStorage.getItem("registeredUsers");
      const registeredUsers = existingUser ? JSON.parse(existingUser) : [];
      
      if (registeredUsers.find((user: any) => user.email === email)) {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      // Simulate Google OAuth signup (in a real app, this would use Google OAuth)
      // For demo purposes, simulate a successful Google signup
      
      // Store simulated Google user data in localStorage
      localStorage.setItem(
        "user",
        JSON.stringify({
          name: "Google User",
